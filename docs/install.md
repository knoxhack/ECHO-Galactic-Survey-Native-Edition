...
Galactic Survey Native Edition installs through ECHO Launcher after verified
release artifacts exist.

The Launcher must resolve `moduleRequirements` from
`release-manifest.template.json`, download `.echo-addon` artifacts for the Native
